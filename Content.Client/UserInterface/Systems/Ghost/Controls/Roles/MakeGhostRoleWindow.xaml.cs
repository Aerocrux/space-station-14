...
namespace Content.Client.UserInterface.Systems.Ghost.Controls.Roles
{
    ...
    {
        public delegate void MakeRole(NetEntity uid, string name, string description, string rules, bool makeSentient, bool allowMovement, bool allowSpeech);
        ...
        public MakeGhostRoleWindow()
        {
            ...
            AllowMovementLabel.MinSize = new Vector2(150, 0);
            AllowSpeechLabel.MinSize = new Vector2(150, 0);
        ...
        private void OnPressed(ButtonEventArgs args)
        {
            ...
            OnMake?.Invoke(Entity.Value, RoleName.Text, RoleDescription.Text, RoleRules.Text, MakeSentientCheckbox.Pressed, AllowMovementCheckbox.Pressed, AllowSpeechCheckbox.Pressed);
        }
    }
}
